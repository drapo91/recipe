package com.drapo.recipe.bootstrap;

import com.drapo.recipe.model.*;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes() {
        ...
        return recipes;
//        UnitOfMeasure pieces=unitOfMeasureRepository.findByDescription("Piece").get();
//
//        Ingredient avocado=new Ingredient();
//        avocado.setDescription("Avocado");
//        avocado.setUom(pieces);
//
...
//
//        Ingredient[] ingredients={avocado,kosherSalt,lemonJuice,mincedRedOnion,serranoChiles,cilantro,blackPepper,tomato};
//
...
//        perfectGuacamole.setIngredients(new HashSet<>(Arrays.asList(ingredients)));
//
